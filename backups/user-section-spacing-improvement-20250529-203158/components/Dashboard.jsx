...
.entry-row::before {
  ...
  right: 0;
  height: 3px;
  background: linear-gradient(90deg, var(--color-accent, #F97316), var(--color-success, #10b981));
  opacity: 0;
...
.entry-row.manual-entry::before {
  background: linear-gradient(90deg, var(--color-warning, #f59e0b), var(--color-accent, #F97316));
  opacity: 0.7;
}
...
.spinner {
  ...
  border-top: 4px solid var(--color-accent, #F97316);
  border-radius: 50%;
